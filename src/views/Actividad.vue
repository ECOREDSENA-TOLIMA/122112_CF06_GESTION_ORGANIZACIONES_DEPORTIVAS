  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Características de los eventos deportivos
        p.mb-4 Identificar los materiales y herramientas que son fundamentales en el proceso de planificación de eventos deportivos.
