  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 3
      h1 Concepto y características de los eventos deportivos
    ...
    .row
      ...
      .col-lg-8(data-aos="fade-left")
        p Los eventos deportivos son extraordinarios, reconocidos a nivel mundial y de gran importancia para la humanidad en su conjunto. Quizás sean el ámbito de mayor impacto en la sociedad, gracias a su capacidad para movilizar, transformar e integrar a las personas a gran escala. Este interés por el deporte se debe en gran medida a su habilidad para generar emociones tanto en quienes lo practican como en quienes lo observan, algo que difícilmente puede lograr otro sector. Tanto es así que los eventos deportivos no solo conciernen a las organizaciones deportivas, sino que también son utilizados por marcas y entidades de otros sectores con el propósito de promocionar sus productos y alcanzar sus objetivos.
    ...
    .row.mt-5
      .col-lg-6.mb-4.mb-lg-0(data-aos="fade-right")
        p Gresser y Bessy (1999), definen:
      ...
      .col-lg-6.mb-4.mb-lg-0(data-aos="fade-left")
        p Martin (1996), define los eventos deportivos como:
        .p-4.cont_3_2.d-flex(style="border-top:1px #FFCA00 solid;")
          i.fas.fa-quote-left.me-3(style="color:#FFCA00;font-size:28px;")
          div.mt-3
    ...
    .row.mt-5
      ...
      .col-lg.mb-4.mb-lg-0
        .tarjeta-numerada.color-acento-botones.p-5.h-100(data-aos="zoom-in" style="box-shadow: 0px 0px 7px rgba(0,0,0,.25);")
          .tarjeta-numerada__numero
            .h2.text-white 2
          p.fw-bold Durante el evento
          p Cubrimiento de cada detalle establecido en el plan, que garantice el desarrollo deportivo bajo parámetros de seguridad, sin contratiempos y/o con un control frente a posibles imprevistos, como lo pueden ser: hidratación, premiación, jueces, entre otros.
      .col-lg.mb-4.mb-lg-0
